...
This repository is intentionally private during review. Complete every unchecked item before making it public.

- [x] Restricted CAD and factory-identifying files excluded
- [x] Anonymous 20-node scenario included
- [x] Source code, frozen checkpoints, and authoritative outputs included
- [x] AnyLogic project renamed and absolute output path removed
